...
SECRET_KEY = 'x8$^#2g6%v@evv(d&4fbk)@bu=hhnpr@c^842td3&4)=m49pc3'
...
# Use custom user model for e-mail based id support from
# django-email-user-model
AUTH_USER_MODEL = 'django_email_user_model.EmailUserModel'

# Enable the auth backend from django_email_user_model
